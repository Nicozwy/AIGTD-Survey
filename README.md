...
|      M4 [[paper](https://arxiv.org/pdf/2402.11175)]     | 122,481 |                Multi-generator, Multi-domain, and Multi-lingua                 |
|      M4GT-Bench [[paper](https://arxiv.org/pdf/2402.11175)]     | 138,465 |                Multi-lingual, Multi-domain, and Multi-generator                 |
|      GTD*   [[paper](https://arxiv.org/pdf/2405.16422)] [[paper]](https://arxiv.org/pdf/2405.06652) |  1,378  |        Open-source dataset, Unknown source        |
|      Reviews24*   [[paper]](https://osf.io/preprints/psyarxiv/mnyz8/download)   |   1200    |       Self-built hotel review dataset        |
|   OpenGen  [[paper](https://arxiv.org/pdf/2401.16820)]  |  3,000  | 3,000 randomly selected two-sentence blocks  |
|    Alpaca  [[paper](https://arxiv.org/pdf/2306.17439)]  |   52,000    |    Used for question and answer task test    |
...
|     XSum   [[paper]](https://arxiv.org/pdf/2402.16041)  |   226,711    |                BBC articles and accompanying single sentence summaries                 |
|     WikiText-2    [[paper]](https://arxiv.org/html/2402.17938v1) |   720    |  Wiki text for language model training and evaluation |
|     WikiText-103    [[paper]](https://arxiv.org/html/2402.17938v1) |   28,595    |  Wiki text for language model training and evaluation |
...
|   BookSum  [[paper]](https://arxiv.org/pdf/2402.11399)  |   \-    |  a collection of datasets for long-form narrative summarization  |
|   RealNews  [[paper]](https://arxiv.org/pdf/1910.10683)  |   \-    |  Filtering C4 to only include news content  |
|   Creative Writing [[paper]](https://arxiv.org/pdf/2401.12970)|   7000    |  Creative writing based on community tips  |
|   Student Essay [[paper]](https://arxiv.org/pdf/2401.12970)|   7000    |  Essays based on the British Academic Written English corpus  |
|   News [[paper]](https://arxiv.org/pdf/2401.12970)|   7000    |  Based on the Reuters 50-50 authorship identification datase  |
